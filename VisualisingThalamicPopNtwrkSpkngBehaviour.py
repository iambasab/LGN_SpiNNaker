...
TotalDuration = 10000 ##'''milliseconds; total simulation time'''
TimeInt = 1 ##'''millisecond'''


''' Creating zeroes-array to store mean values'''
TCR_mean = np.array([0]*TotalDuration)
TRN_mean = np.array([0]*TotalDuration)
IN_mean = np.array([0]*TotalDuration)
...
#Loading files
spike_source_ex = np.loadtxt('./Sim3_3hz_0916/spikesource_ex_'+`loop`+'.dat')
spike_source_inh = np.loadtxt('./Sim3_3hz_0916/spikesource_inh_'+`loop`+'.dat')
TCRspikes = np.loadtxt('./Sim3_3hz_0916/TCRspikes_'+`loop`+'.dat')
INspikes = np.loadtxt('./Sim3_3hz_0916/INspikes_'+`loop`+'.dat')
TRNspikes = np.loadtxt('./Sim3_3hz_0916/TRNspikes_'+`loop`+'.dat')


TCRmempot = np.loadtxt('./Sim3_3hz_0916/TCRmempot_'+`loop`+'.dat')
INmempot = np.loadtxt('./Sim3_3hz_0916/INmempot_'+`loop`+'.dat')
TRNmempot = np.loadtxt('./Sim3_3hz_0916/TRNmempot_'+`loop`+'.dat')
...
TCR = signalTCR.reshape(NumCellsTCR, TotalDuration)
IN = signalIN.reshape(NumCellsIN, TotalDuration)
TRN = signalTRN.reshape(NumCellsTRN, TotalDuration)
...
t = np.arange(0, TotalDuration, TimeInt)
plt.subplot(3,1,3)
